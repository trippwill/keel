...
type ExtentConstraint = core.ExtentConstraint

// FlexUnit returns a single flexible unit of space with no minimum.
func FlexUnit() ExtentConstraint {
	return ExtentConstraint{Kind: core.ExtentFlex, Units: 1, MinCells: 0, MaxCells: 0}
}
...
func Fixed(units int) ExtentConstraint {
	return ExtentConstraint{Kind: core.ExtentFixed, Units: units, MinCells: units, MaxCells: 0}
}
...
func Flex(units int) ExtentConstraint {
	return ExtentConstraint{Kind: core.ExtentFlex, Units: units, MinCells: 0, MaxCells: 0}
}
...
func FlexMin(units int, minReserved int) ExtentConstraint {
	return ExtentConstraint{Kind: core.ExtentFlex, Units: units, MinCells: minReserved, MaxCells: 0}
}
...
func FlexMax(units int, maxCells int) ExtentConstraint {
	return ExtentConstraint{Kind: core.ExtentFlex, Units: units, MinCells: 0, MaxCells: maxCells}
}
...
func FlexMinMax(units int, minReserved int, maxCells int) ExtentConstraint {
	return ExtentConstraint{Kind: core.ExtentFlex, Units: units, MinCells: minReserved, MaxCells: maxCells}
}
